...
class IndexExistsRequestTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->request = new IndexExistsRequest(self::INDEX, self::TYPE, $this->serializer);
    }
    ...
    public function testInstance()
    {
        ...
        $this->assertInstanceOf(
            'Elastification\Client\Request\V2x\Index\IndexExistsRequest',
            $this->request
        );
    }
