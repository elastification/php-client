...
use Elastification\Client\Request\V2x\Index\UpdateAliasesRequest;

class UpdateAliasesRequestTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->request = new UpdateAliasesRequest(self::INDEX, null, $this->serializer);
    }
    ...
    public function testInstance()
    {
        ...
        $this->assertInstanceOf(
            'Elastification\Client\Request\Shared\Index\AbstractUpdateAliasesRequest',
            $this->request
        );

        $this->assertInstanceOf(
            'Elastification\Client\Request\V2x\Index\UpdateAliasesRequest',
            $this->request
        );
    }
    ...
    {
        $this->assertSame(UpdateAliasesRequest::REQUEST_ACTION, $this->request->getAction());
    }
