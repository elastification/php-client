...
use Elastification\Client\Request\Shared\Cat\AbstractShardsCatRequest;
use Elastification\Client\Request\V2x\Cat\ShardsCatRequest;

class ShardsCatRequestTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->request = new ShardsCatRequest(null, null, $this->serializer);
    }
    ...
    public function testInstance()
    {
        ...
        $this->assertInstanceOf(
            'Elastification\Client\Request\Shared\Cat\AbstractShardsCatRequest',
            $this->request
        );

        $this->assertInstanceOf(
            'Elastification\Client\Request\V2x\Cat\ShardsCatRequest',
            $this->request
        );
    }
    ...
    {
        $this->assertSame(AbstractShardsCatRequest::REQUEST_ACTION, $this->request->getIndex());
    }
    ...
    {
        $this->assertSame(AbstractShardsCatRequest::CAT_TYPE, $this->request->getAction());
    }
//
