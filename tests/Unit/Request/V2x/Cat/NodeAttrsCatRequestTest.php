...
class NodeAttrsCatRequestTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->request = new NodeAttrsCatRequest(null, null, $this->serializer);
    }
    ...
    public function testInstance()
    {
        ...
        $this->assertInstanceOf(
            'Elastification\Client\Request\V2x\Cat\NodeAttrsCatRequest',
            $this->request
        );
    }
    ...
    {
        $this->assertSame(NodeAttrsCatRequest::REQUEST_ACTION, $this->request->getIndex());
    }
    ...
    {
        $this->assertSame(NodeAttrsCatRequest::CAT_TYPE, $this->request->getAction());
    }
//
