...
use Elastification\Client\Request\Shared\Cat\AbstractMasterCatRequest;
use Elastification\Client\Request\V2x\Cat\MasterCatRequest;

class MasterCatRequestTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->request = new MasterCatRequest(null, null, $this->serializer);
    }
    ...
    public function testInstance()
    {
        ...
        $this->assertInstanceOf(
            'Elastification\Client\Request\Shared\Cat\AbstractMasterCatRequest',
            $this->request
        );

        $this->assertInstanceOf(
            'Elastification\Client\Request\V2x\Cat\MasterCatRequest',
            $this->request
        );
    }
    ...
    {
        $this->assertSame(AbstractMasterCatRequest::REQUEST_ACTION, $this->request->getIndex());
    }
    ...
    {
        $this->assertSame(AbstractMasterCatRequest::CAT_TYPE, $this->request->getAction());
    }
//
