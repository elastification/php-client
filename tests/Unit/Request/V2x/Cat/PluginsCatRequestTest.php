...
use Elastification\Client\Request\Shared\Cat\AbstractPluginsCatRequest;
use Elastification\Client\Request\V2x\Cat\PluginsCatRequest;

class PluginsCatRequestTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->request = new PluginsCatRequest(null, null, $this->serializer);
    }
    ...
    public function testInstance()
    {
        ...
        $this->assertInstanceOf(
            'Elastification\Client\Request\Shared\Cat\AbstractPluginsCatRequest',
            $this->request
        );

        $this->assertInstanceOf(
            'Elastification\Client\Request\V2x\Cat\PluginsCatRequest',
            $this->request
        );
    }
    ...
    {
        $this->assertSame(AbstractPluginsCatRequest::REQUEST_ACTION, $this->request->getIndex());
    }
    ...
    {
        $this->assertSame(AbstractPluginsCatRequest::CAT_TYPE, $this->request->getAction());
    }
//
