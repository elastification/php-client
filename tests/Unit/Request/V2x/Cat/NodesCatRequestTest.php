...
use Elastification\Client\Request\V2x\Cat\NodesCatRequest;

class NodesCatRequestTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->request = new NodesCatRequest(null, null, $this->serializer);
    }
    ...
    public function testInstance()
    {
        ...
        $this->assertInstanceOf(
            'Elastification\Client\Request\Shared\Cat\AbstractNodesCatRequest',
            $this->request
        );

        $this->assertInstanceOf(
            'Elastification\Client\Request\V2x\Cat\NodesCatRequest',
            $this->request
        );
    }
    ...
    {
        $this->assertSame(AbstractNodesCatRequest::REQUEST_ACTION, $this->request->getIndex());
    }
    ...
    {
        $this->assertSame(AbstractNodesCatRequest::CAT_TYPE, $this->request->getAction());
    }
//
