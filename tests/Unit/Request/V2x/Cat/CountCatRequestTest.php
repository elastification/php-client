...
use Elastification\Client\Request\V2x\Cat\CountCatRequest;
...
class CountCatRequestTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->request = new CountCatRequest(null, null, $this->serializer);
    }
    ...
    public function testInstance()
    {
        ...
        $this->assertInstanceOf(
            'Elastification\Client\Request\Shared\Cat\AbstractCountCatRequest',
            $this->request
        );

        $this->assertInstanceOf(
            'Elastification\Client\Request\V2x\Cat\CountCatRequest',
            $this->request
        );
    }
    ...
    {
        $this->assertSame(CountCatRequest::REQUEST_ACTION, $this->request->getIndex());
    }
    ...
    {
        $this->assertSame(CountCatRequest::CAT_TYPE, $this->request->getAction());
    }
//
