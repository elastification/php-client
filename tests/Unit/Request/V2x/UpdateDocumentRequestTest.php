...
use Elastification\Client\Request\V2x\UpdateDocumentRequest;

class UpdateDocumentRequestTest extends \PHPUnit_Framework_TestCase
{
    const INDEX = 'test-index';
    const TYPE = 'test-type';
    const RESPONSE_CLASS = 'Elastification\Client\Response\V2x\CreateUpdateDocumentResponse';
    ...
    public function testInstance()
    {
        ...
        $this->assertInstanceOf(
            'Elastification\Client\Request\V2x\UpdateDocumentRequest',
            $this->request
        );
    }
