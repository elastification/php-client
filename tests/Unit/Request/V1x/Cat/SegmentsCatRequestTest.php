...
use Elastification\Client\Request\Shared\Cat\AbstractSegmentsCatRequest;
use Elastification\Client\Request\V1x\Cat\SegmentsCatRequest;

class SegmentsCatRequestTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->request = new SegmentsCatRequest(null, null, $this->serializer);
    }
    ...
    public function testInstance()
    {
        ...
        $this->assertInstanceOf(
            'Elastification\Client\Request\Shared\Cat\AbstractSegmentsCatRequest',
            $this->request
        );

        $this->assertInstanceOf(
            'Elastification\Client\Request\V1x\Cat\SegmentsCatRequest',
            $this->request
        );
    }
    ...
    {
        $this->assertSame(AbstractSegmentsCatRequest::REQUEST_ACTION, $this->request->getIndex());
    }
    ...
    {
        $this->assertSame(AbstractSegmentsCatRequest::CAT_TYPE, $this->request->getAction());
    }
//
