...
use Elastification\Client\Request\Shared\Cat\AbstractThreadPoolCatRequest;
use Elastification\Client\Request\V1x\Cat\ThreadPoolCatRequest;

class ThreadPoolCatRequestTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->request = new ThreadPoolCatRequest(null, null, $this->serializer);
    }
    ...
    public function testInstance()
    {
        ...
        $this->assertInstanceOf(
            'Elastification\Client\Request\Shared\Cat\AbstractThreadPoolCatRequest',
            $this->request
        );

        $this->assertInstanceOf(
            'Elastification\Client\Request\V1x\Cat\ThreadPoolCatRequest',
            $this->request
        );
    }
    ...
    {
        $this->assertSame(AbstractThreadPoolCatRequest::REQUEST_ACTION, $this->request->getIndex());
    }
    ...
    {
        $this->assertSame(AbstractThreadPoolCatRequest::CAT_TYPE, $this->request->getAction());
    }
//
