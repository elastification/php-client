...
class RefreshIndexRequestTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->request = new RefreshIndexRequest(self::INDEX, null, $this->serializer);
    }
    ...
    public function testInstance()
    {
        ...
        $this->assertInstanceOf(
            'Elastification\Client\Request\V1x\Index\RefreshIndexRequest',
            $this->request
        );
    }
    ...
    {
        $this->assertSame(RefreshIndexRequest::REQUEST_ACTION, $this->request->getAction());
    }
