...
class NodeInfoRequestTest extends \PHPUnit_Framework_TestCase
{
    const INDEX = 'test-template';
    const RESPONSE_CLASS = 'Elastification\Client\Response\V090x\NodeInfoResponse';
    ...
    protected function setUp()
    {
        ...
        $this->request = new NodeInfoRequest($this->serializer);
    }
    ...
    public function testInstance()
    {
        ...
        $this->assertInstanceOf(
            'Elastification\Client\Request\Shared\AbstractNodeInfoRequest',
            $this->request
        );

        $this->assertInstanceOf(
            'Elastification\Client\Request\V090x\NodeInfoRequest',
            $this->request
        );
    }
