...
class AliasesRequestTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->request = new AliasesRequest(self::INDEX, self::TYPE, $this->serializer);
    }
    ...
    public function testInstance()
    {
        ...
        $this->assertInstanceOf(
            'Elastification\Client\Request\Shared\AbstractAliasesRequest',
            $this->request
        );

        $this->assertInstanceOf(
            'Elastification\Client\Request\V090x\AliasesRequest',
            $this->request
        );
    }
    ...
    {
        $this->assertSame(AliasesRequest::REQUEST_ACTION, $this->request->getAction());
    }
