...
class IndexStatsRequestTest extends \PHPUnit_Framework_TestCase
{
    const INDEX = 'test-index';
    const RESPONSE_CLASS = 'Elastification\Client\Response\V090x\Index\IndexStatsResponse';
    ...
    protected function setUp()
    {
        ...
        $this->request = new IndexStatsRequest(self::INDEX, null, $this->serializer);
    }
    ...
    public function testInstance()
    {
        ...
        $this->assertInstanceOf(
            'Elastification\Client\Request\Shared\Index\AbstractIndexStatsRequest',
            $this->request
        );

        $this->assertInstanceOf(
            'Elastification\Client\Request\V090x\Index\IndexStatsRequest',
            $this->request
        );
    }
    ...
    {
        $this->assertSame(IndexStatsRequest::REQUEST_ACTION, $this->request->getAction());
    }
