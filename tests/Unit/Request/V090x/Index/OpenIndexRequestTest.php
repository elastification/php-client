...
class OpenIndexRequestTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->request = new OpenIndexRequest(self::INDEX, null, $this->serializer);
    }
    ...
    public function testInstance()
    {
        ...
        $this->assertInstanceOf(
            'Elastification\Client\Request\Shared\Index\AbstractOpenIndexRequest',
            $this->request
        );

        $this->assertInstanceOf(
            'Elastification\Client\Request\V090x\Index\OpenIndexRequest',
            $this->request
        );
    }
    ...
    {
        $this->assertSame(OpenIndexRequest::REQUEST_ACTION, $this->request->getAction());
    }
