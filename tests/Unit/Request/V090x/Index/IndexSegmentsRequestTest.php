...
class IndexSegmentsRequestTest extends \PHPUnit_Framework_TestCase
{
    const INDEX = 'test-index';
    const RESPONSE_CLASS = 'Elastification\Client\Response\V090x\Index\IndexStatusResponse';
    ...
    protected function setUp()
    {
        ...
        $this->request = new IndexSegmentsRequest(self::INDEX, null, $this->serializer);
    }
    ...
    public function testInstance()
    {
        ...
        $this->assertInstanceOf(
            'Elastification\Client\Request\Shared\Index\AbstractIndexSegmentsRequest',
            $this->request
        );

        $this->assertInstanceOf(
            'Elastification\Client\Request\V090x\Index\IndexSegmentsRequest',
            $this->request
        );
    }
    ...
    {
        $this->assertSame(IndexSegmentsRequest::REQUEST_ACTION, $this->request->getAction());
    }
