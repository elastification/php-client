...
use Elastification\Client\Request\V090x\Index\UpdateIndexSettingsRequest;

class UpdateIndexSettingsRequestTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->request = new UpdateIndexSettingsRequest(self::INDEX, null, $this->serializer);
    }
    ...
    public function testInstance()
    {
        ...
        $this->assertInstanceOf(
            'Elastification\Client\Request\Shared\Index\AbstractUpdateIndexSettingsRequest',
            $this->request
        );

        $this->assertInstanceOf(
            'Elastification\Client\Request\V090x\Index\UpdateIndexSettingsRequest',
            $this->request
        );
    }
