...
class IndexOptimizeRequestTest extends \PHPUnit_Framework_TestCase
{
    const INDEX = 'test-index';
    const RESPONSE_CLASS = 'Elastification\Client\Response\V090x\Index\RefreshIndexResponse';
    ...
    protected function setUp()
    {
        ...
        $this->request = new IndexOptimizeRequest(self::INDEX, null, $this->serializer);
    }
    ...
    public function testInstance()
    {
        ...
        $this->assertInstanceOf(
            'Elastification\Client\Request\Shared\Index\AbstractIndexOptimizeRequest',
            $this->request
        );

        $this->assertInstanceOf(
            'Elastification\Client\Request\V090x\Index\IndexOptimizeRequest',
            $this->request
        );
    }
    ...
    {
        $this->assertSame(IndexOptimizeRequest::REQUEST_ACTION, $this->request->getAction());
    }
