...
class CloseIndexRequestTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->request = new CloseIndexRequest(self::INDEX, null, $this->serializer);
    }
    ...
    public function testInstance()
    {
        ...
        $this->assertInstanceOf(
            'Elastification\Client\Request\Shared\Index\AbstractCloseIndexRequest',
            $this->request
        );

        $this->assertInstanceOf(
            'Elastification\Client\Request\V090x\Index\CloseIndexRequest',
            $this->request
        );
    }
    ...
    {
        $this->assertSame(CloseIndexRequest::REQUEST_ACTION, $this->request->getAction());
    }
