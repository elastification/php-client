...
class GetAliasesRequestTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->request = new GetAliasesRequest(self::INDEX, self::TYPE, $this->serializer);
    }
    ...
    public function testInstance()
    {
        ...
        $this->assertInstanceOf(
            'Elastification\Client\Request\Shared\Index\AbstractGetAliasesRequest',
            $this->request
        );

        $this->assertInstanceOf(
            'Elastification\Client\Request\V090x\Index\GetAliasesRequest',
            $this->request
        );
    }
    ...
    {
        $this->assertSame(GetAliasesRequest::REQUEST_ACTION, $this->request->getAction());
    }
