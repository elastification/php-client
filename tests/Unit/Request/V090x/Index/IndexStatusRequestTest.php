...
class IndexStatusRequestTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->request = new IndexStatusRequest(self::INDEX, null, $this->serializer);
    }
    ...
    public function testInstance()
    {
        ...
        $this->assertInstanceOf(
            'Elastification\Client\Request\Shared\Index\AbstractIndexStatusRequest',
            $this->request
        );

        $this->assertInstanceOf(
            'Elastification\Client\Request\V090x\Index\IndexStatusRequest',
            $this->request
        );
    }
    ...
    {
        $this->assertSame(IndexStatusRequest::REQUEST_ACTION, $this->request->getAction());
    }
