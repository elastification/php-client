...
class IndexFlushRequestTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->request = new IndexFlushRequest(self::INDEX, null, $this->serializer);
    }
    ...
    public function testInstance()
    {
        ...
        $this->assertInstanceOf(
            'Elastification\Client\Request\Shared\Index\AbstractIndexFlushRequest',
            $this->request
        );

        $this->assertInstanceOf(
            'Elastification\Client\Request\V090x\Index\IndexFlushRequest',
            $this->request
        );
    }
    ...
    {
        $this->assertSame(IndexFlushRequest::REQUEST_ACTION, $this->request->getAction());
    }
