...
class GetWarmerRequestTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->request = new GetWarmerRequest(self::INDEX, null, $this->serializer);
    }
    ...
    public function testInstance()
    {
        ...
        $this->assertInstanceOf(
            'Elastification\Client\Request\Shared\Index\AbstractGetWarmerRequest',
            $this->request
        );

        $this->assertInstanceOf(
            'Elastification\Client\Request\V090x\Index\GetWarmerRequest',
            $this->request
        );
    }
    ...
    public function testGetAction()
    {
        ...
        $this->assertSame(GetWarmerRequest::REQUEST_ACTION . '/' . $warmerName, $this->request->getAction());
    }
