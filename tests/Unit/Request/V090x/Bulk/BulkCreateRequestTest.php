...
class BulkCreateRequestTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->request = new BulkCreateRequest(self::INDEX, self::TYPE, $this->serializer);
    }
    ...
    public function testInstance()
    {
        ...
        $this->assertInstanceOf(
            'Elastification\Client\Request\Shared\Bulk\AbstractBulkCreateRequest',
            $this->request
        );

        $this->assertInstanceOf(
            'Elastification\Client\Request\V090x\Bulk\BulkCreateRequest',
            $this->request
        );
    }
    ...
    public function testAddAction()
    {
        ...
        $action = array(
            AbstractBulkCreateRequest::BULK_ACTION => array(
                '_id' => $id,
                '_index' => self::INDEX,
                '_type' => self::TYPE
            )
        ...
        $expected = json_encode($action) .
            AbstractBulkCreateRequest::LINE_BREAK .
            $serializedDoc .
            AbstractBulkCreateRequest::LINE_BREAK;
